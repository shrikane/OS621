...
%%         2. # of segmentations
%%  Output: segmentations of the original file written to ./seg/F_index
%%  
%%       Note:    
%%              # of segmentation might be +1 or +2 than you expect. Most of the time it works, 
%%              output directory is hard coded as under ./seg so you need to mkdir seg under current directory 
%%    
